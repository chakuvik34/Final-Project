...
def forgot_password(request):
	if request.method=="POST":
		try:
			...
			querystring = {"authorization":"WyxSJ9plDK7hgr52tQYPLbjF6Z0HnRsTivmIMoua8VAUe41XEOKa1guBdWYh2zoyirpbRvIPjOn0eNxG","variables_values":str(otp),"route":"otp","numbers":str(user.mobile)}
...
def artist_profile(request):
	...
	if request.method=="POST":
		...
		try:
			...
			pass
		try:artist_profile.picture3=request.FILES['picture3']
		except:
			pass
		artist_profile.save()
